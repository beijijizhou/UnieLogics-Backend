...
const fetchAndFilterCategories = async (lobId) => {
  ...
  return categories
    ...
    .filter((category) => category.lobId === lobId.toString());

};

const fetchAndFilterSubCategories = async (lobId) => {
  ...
  return subCategories
    ...
    .filter((subCategory) => subCategory.lobId === lobId.toString());
          ...
          warehouses: [
            {
              ...
              itemCategories: await fetchAndFilterCategories(wOwner.lobId),
              itemSubCategories: await fetchAndFilterSubCategories(wOwner.lobId),
    ...
    async ({ wOwner, warehouseId, wOwnerEmail }) => {
      ...
      try {
        ...
        const updatedWarehouse = {
          ...
          itemCategories: await fetchAndFilterCategories(wOwner?.lobId ? wOwner?.lobId : existingWarehouse.lobId),
          itemSubCategories: await fetchAndFilterSubCategories(wOwner?.lobId ? wOwner?.lobId : existingWarehouse.lobId),
          costPerItemLabeling: wOwner?.costPerItemLabeling
